package com.chengm.pirate.utils.ids;

import java.util.concurrent.locks.ReentrantLock;

/**
 * program: CmPirate
 * description: 全局唯一 uid 生成工具
 * author: ChengMo
 * create: 2019-11-30 20:57
 **/
public class IdGenerator {
    ...
    private IdGenerator(long groupId, long id) {
        if (id <= 31L && id >= 0L) {
    ...
    public long nextId() {
        ...
        try {
            ...
            var5 = timestamp - 1404741526058L << 22 | this.dbGroupId << 17 | this.databaseId << 12 | this.sequence;
        } finally {
            this.lock.unlock();
        }
